...
<form method="POST" action="{{ route('patient.store') }}">
    ...
    <div class="form-group">
        ...
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="ethnicity" id="hispanic_or_latino" value="hispanic_or_latino">
            <label class="form-check-label" for="hispanic_or_latino">Hispanic or Latino</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="ethnicity" id="not_hispanic_or_latino" value="not_hispanic_or_latino">
            <label class="form-check-label" for="not_hispanic_or_latino">Not Hispanic or Latino</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="ethnicity" id="unknown" value="unknown">
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control" id="year_emigrated_to_us" name="year_emigrated_to_us">
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="type_of_facility" name="type_of_facility">
                <option value="nursing_home_longterm_care_facility">Nursing Home/Long-term care facility</option>
                <option value="residential_program_treatment_facility">Residential program/treatment facility</option>
